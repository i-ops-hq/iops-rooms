...
1. Prefer one-command install: `npx -y iops-rooms@0.5.3 mcp install` (or `rooms mcp install`). Merges `.cursor/mcp.json` and copies this skill to `.cursor/skills/rooms/SKILL.md`.
